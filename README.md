# 노인 무임승차와 지하철 적자 실증 분석 — 프로젝트 사이트

26-1학기 데이터분석언어 개인 프로젝트 「노인 무임승차와 지하철 적자 실증 분석」 결과보고서를 소개하는 정적 웹사이트입니다.
...
저장소 Settings → Pages → Branch를 배포할 브랜치, 폴더를 `/ (root)`로 설정하면 됩니다.
